...
tableWriters.DepartmentTableWriter(
	...
	[2014]
).write(outputDirectory+'/2014.0.p.'+str(documentNumber)+'.3.department.set(2014).csv')
tableWriters.DepartmentTableWriter(
	makeTableReaderFromXlsxFile(inputDirectory+'/fincom/2014.0.p/pr04-2014-16.xlsx',2),
	[2015,2016]
).write(outputDirectory+'/2014.0.p.'+str(documentNumber)+'.4.department.set(2015,2016).csv')
tableWriters.SectionTableWriter(
	makeTableReaderFromXlsxFile(inputDirectory+'/fincom/2014.0.p/pr05-2014-16.xlsx',1),
	[2014]
).write(outputDirectory+'/2014.0.p.'+str(documentNumber)+'.5.section.set(2014).csv')
tableWriters.SectionTableWriter(
	makeTableReaderFromXlsxFile(inputDirectory+'/fincom/2014.0.p/pr06-2014-16.xlsx',2),
	[2015,2016]
).write(outputDirectory+'/2014.0.p.'+str(documentNumber)+'.6.section.set(2015,2016).csv')
...
tableWriters.DepartmentTableWriter(
	...
	[2014]
).write(outputDirectory+'/2014.0.z.'+str(documentNumber)+'.3.department.set(2014).csv')
tableWriters.DepartmentTableWriter(
	makeTableReaderFromXlsxFile(inputDirectory+'/fincom/2014.0.z/pr04_bd2014-16.xlsx',2),
	[2015,2016]
).write(outputDirectory+'/2014.0.z.'+str(documentNumber)+'.4.department.set(2015,2016).csv')
tableWriters.SectionTableWriter(
	makeTableReaderFromXlsxFile(inputDirectory+'/fincom/2014.0.z/pr05_bd2014-16.xlsx',1),
	[2014]
).write(outputDirectory+'/2014.0.z.'+str(documentNumber)+'.5.section.set(2014).csv')
tableWriters.SectionTableWriter(
	makeTableReaderFromXlsxFile(inputDirectory+'/fincom/2014.0.z/pr06_bd2014-16.xlsx',2),
	[2015,2016]
).write(outputDirectory+'/2014.0.z.'+str(documentNumber)+'.6.section.set(2015,2016).csv')
...
tableWriters.DepartmentTableWriter(
	...
	[2014]
).write(outputDirectory+'/2014.1.z.'+str(documentNumber)+'.2.department.set(2014).csv')
tableWriters.DepartmentTableWriter(
	makeTableReaderFromXlsxFile(inputDirectory+'/fincom/2014.1.z/pr17_bd2014-16_1izm.xlsx',2),
	[2015,2016]
).write(outputDirectory+'/2014.1.z.'+str(documentNumber)+'.17.department.diffset('+str(diffsetDocumentNumber)+',2015,2016).csv')
tableWriters.SectionTableWriter(
	makeTableReaderFromXlsxFile(inputDirectory+'/fincom/2014.1.z/pr03_bd2014-16_1izm.xlsx',1),
	[2014]
).write(outputDirectory+'/2014.1.z.'+str(documentNumber)+'.3.section.set(2014).csv')
tableWriters.SectionTableWriter(
	makeTableReaderFromXlsxFile(inputDirectory+'/fincom/2014.1.z/pr18_bd2014-16_1izm.xlsx',2),
	[2015,2016]
).write(outputDirectory+'/2014.1.z.'+str(documentNumber)+'.18.section.diffset('+str(diffsetDocumentNumber)+',2015,2016).csv')
